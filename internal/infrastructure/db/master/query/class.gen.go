...
func newClass(db *gorm.DB, opts ...gen.DOOption) class {
	...
	_class.GradeYearID = field.NewInt64(tableName, "grade_year_id")
	...
	_class.CreatedBy = field.NewString(tableName, "created_by")
	_class.UpdatedBy = field.NewString(tableName, "updated_by")
...
type class struct {
	...
	ALL         field.Asterisk
	ID          field.Int64  // 班级ID
	GradeYearID field.Int64  // 年级学年ID（逻辑外键）
	Name        field.String // 班级名称，例如 1班、2班
...
func (c *class) updateTableName(table string) *class {
	...
	c.GradeYearID = field.NewInt64(table, "grade_year_id")
...
func (c *class) fillFieldMap() {
	...
	c.fieldMap["id"] = c.ID
	c.fieldMap["grade_year_id"] = c.GradeYearID
